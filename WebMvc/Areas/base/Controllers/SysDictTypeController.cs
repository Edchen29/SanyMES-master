...
namespace WebMvc
{
    ...
    {
        private readonly SysDictTypeApp _app;
        
        public SysDictTypeController(IAuth authUtil, SysDictTypeApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(SysDictType Table_entity)
        {
            try
            {
