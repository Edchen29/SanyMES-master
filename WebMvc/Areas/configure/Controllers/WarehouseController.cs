...
namespace WebMvc
{
    ...
    {
        private readonly WarehouseApp _app;
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(Warehouse Table_entity)
        {
            try
            {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Upd(Warehouse Table_entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Export(Warehouse entity)
        {
        ...
        public string GetTemplate()
        {
            ...
            Warehouse entity = _app.FindSingle(u => u.Id > 0);
            if (entity != null)
            {
            ...
            result.data = listWarehouse;
            result.count = listWarehouse.Count;
