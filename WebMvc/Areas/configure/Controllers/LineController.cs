...
namespace WebMvc
{
    ...
    public class LineController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Load(PageReq pageRequest, Line entity)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(Line Table_entity)
        {
            try
            {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Upd(Line Table_entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Export(Line entity)
        {
        ...
        public string GetTemplate()
        {
            ...
            Line entity = _app.FindSingle(u => u.Id > 0);
            if (entity != null)
            {
                listLine.Add(entity);
            }
            ...
            result.data = listLine;
            result.count = listLine.Count;
