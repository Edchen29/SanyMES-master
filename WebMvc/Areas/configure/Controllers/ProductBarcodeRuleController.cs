...
namespace WebMvc
{
	...
	/// </summary>
    [Area("configure")]
    public class ProductBarcodeRuleController : BaseController
    {
        private readonly ProductBarcodeRuleApp _app;
        
        public ProductBarcodeRuleController(IAuth authUtil, ProductBarcodeRuleApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(ProductBarcodeRule Table_entity)
        {
            try
            {
