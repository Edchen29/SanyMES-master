...
namespace WebMvc
{
    ...
    {
        private readonly MaterialUnitApp _app;
        
        public MaterialUnitController(IAuth authUtil, MaterialUnitApp app) : base(authUtil)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Load(PageReq pageRequest, MaterialUnit entity)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(MaterialUnit Table_entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Export(MaterialUnit entity)
        {
