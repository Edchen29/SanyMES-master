...
namespace WebMvc
{
    ...
    public class MaterialTypeController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Load(PageReq pageRequest, MaterialType entity)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(MaterialType Table_entity)
        {
            try
            {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Upd(MaterialType Table_entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Export(MaterialType entity)
        {
        ...
        public string GetTemplate()
        {
            ...
            MaterialType entity = _app.FindSingle(u => u.Id > 0);
            if (entity != null)
            {
                listMaterialType.Add(entity);
            }
            else
            {
                listMaterialType.Add(new MaterialType());
            }
 
            result.data = listMaterialType;
            result.count = listMaterialType.Count;
