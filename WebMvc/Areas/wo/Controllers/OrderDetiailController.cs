...
namespace WebMvc
{
	...
	/// </summary>
    [Area("wo")]
    public class OrderDetiailController : BaseController
    {
        private readonly OrderDetiailApp _app;
        
        public OrderDetiailController(IAuth authUtil, OrderDetiailApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(OrderDetiail Table_entity)
        {
            try
            {
