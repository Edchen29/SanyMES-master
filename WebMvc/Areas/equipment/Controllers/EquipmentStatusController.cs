...
namespace WebMvc
{
    ...
    {
        private readonly EquipmentStatusApp _app;
        
        public EquipmentStatusController(IAuth authUtil, EquipmentStatusApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(EquipmentStatus Table_entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Export(EquipmentStatus entity)
        {
