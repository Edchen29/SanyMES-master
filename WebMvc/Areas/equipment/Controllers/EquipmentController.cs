...
namespace WebMvc
{
    ...
    {
        private readonly EquipmentApp _app;
        
        public EquipmentController(IAuth authUtil, EquipmentApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(Equipment Table_entity)
        {
            try
            {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Upd(Equipment Table_entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Export(Equipment entity)
        {
        ...
        public string GetTemplate()
        {
            ...
            Equipment entity = _app.FindSingle(u => u.Id > 0);
            if (entity != null)
            {
            ...
            result.data = listEquipment;
            result.count = listEquipment.Count;
