...
namespace WebMvc
{
	...
	/// </summary>
    [Area("equipment")]
    public class EquipmentPropController : BaseController
    {
        private readonly EquipmentPropApp _app;
        
        public EquipmentPropController(IAuth authUtil, EquipmentPropApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(EquipmentProp Table_entity)
        {
            try
            {
