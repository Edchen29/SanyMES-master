...
namespace WebMvc
{
	...
	/// </summary>
    [Area("monitor")]
    public class AgvMonitorController : BaseController
    {
        private readonly AgvMonitorApp _app;
        
        public AgvMonitorController(IAuth authUtil, AgvMonitorApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(AgvMonitor Table_entity)
        {
            try
            {
