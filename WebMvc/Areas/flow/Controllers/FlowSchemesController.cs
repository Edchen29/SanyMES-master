...
namespace WebMvc
{
    ...
    public class FlowSchemesController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Load(PageReq pageRequest, FlowScheme entity)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(FlowScheme Table_entity)
        {
            try
            {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Upd(FlowScheme Table_entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public string Export(FlowScheme entity)
        {
        ...
        public string GetTemplate()
        {
            ...
            List<FlowScheme> listFlowScheme = new List<FlowScheme>();
            FlowScheme entity = _app.FindSingle(u => u.Id > 0);
            if (entity != null)
            {
            ...
            {
                listFlowScheme.Add(new FlowScheme());
            }
