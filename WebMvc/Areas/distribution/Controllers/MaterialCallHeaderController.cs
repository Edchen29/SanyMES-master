...
namespace WebMvc
{
	...
	/// </summary>
    [Area("distribution")]
    public class MaterialCallHeaderController : BaseController
    {
        private readonly MaterialCallHeaderApp _app;
        
        public MaterialCallHeaderController(IAuth authUtil, MaterialCallHeaderApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(MaterialCallHeader Table_entity)
        {
            try
            {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string CreateDistributeTask(List<MaterialCallHeader> materialcallheaderlist)
        {
            return JsonHelper.Instance.Serialize(_app.CreateDistributeTaskApp(materialcallheaderlist));
        }
        #endregion
    }
}