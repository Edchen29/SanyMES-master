...
namespace WebMvc
{
	...
	/// </summary>
    [Area("distribution")]
    public class MaterialDemandController : BaseController
    {
        private readonly MaterialDemandApp _app;
        
        public MaterialDemandController(IAuth authUtil, MaterialDemandApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(MaterialDemand Table_entity)
        {
            try
            {
