...
namespace WebMvc
{
	...
	/// </summary>
    [Area("distribution")]
    public class MaterialDistributeTaskDetailController : BaseController
    {
        private readonly MaterialDistributeTaskDetailApp _app;
        
        public MaterialDistributeTaskDetailController(IAuth authUtil, MaterialDistributeTaskDetailApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(MaterialDistributeTaskDetail Table_entity)
        {
            try
            {
