...
namespace WebMvc
{
    ...
    {
        private readonly DefectCodeApp _app;
        
        public DefectCodeController(IAuth authUtil, DefectCodeApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(DefectCode Table_entity)
        {
            try
            {
