...
namespace WebMvc
{
	...
	/// </summary>
    [Area("repair")]
    public class RepairCodeController : BaseController
    {
        private readonly RepairCodeApp _app;
        
        public RepairCodeController(IAuth authUtil, RepairCodeApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(RepairCode Table_entity)
        {
            try
            {
