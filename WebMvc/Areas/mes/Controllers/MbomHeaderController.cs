...
namespace WebMvc
{
	...
	/// </summary>
    [Area("mes")]
    public class MbomHeaderController : BaseController
    {
        private readonly MbomHeaderApp _app;
        
        public MbomHeaderController(IAuth authUtil, MbomHeaderApp app) : base(authUtil)
        {
        ...
        [HttpPost]
        [ServiceFilter(typeof(OperLogFilter))]
        public string Ins(MbomHeader Table_entity)
        {
            try
            {
