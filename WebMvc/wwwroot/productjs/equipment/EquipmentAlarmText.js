layui.config({
    ...
    var TableName = 'EquipmentAlarmText';
    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'Code', width:150, sort: true, fixed: false, hide: false, title: '警示代号' }
                , {field:'Text', width:150, sort: true, fixed: false, hide: false, title: '警示语句' }
