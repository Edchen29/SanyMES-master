    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , { field: 'Enable', width: 150, sort: true, fixed: false, hide: false, title: '是否生效', templet: function (d) { return GetLabel('Enable', 'DictValue', 'DictLabel', d.Enable) } }
