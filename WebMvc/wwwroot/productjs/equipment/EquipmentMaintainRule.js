layui.config({
    ...
    var TableName = 'EquipmentMaintainRule';
    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'EquipmentItemId', width:150, sort: true, fixed: false, hide: false, title: '设备部件编号' }
                , {field:'Times', width:150, sort: true, fixed: false, hide: false, title: '时间（天）' }
                , {field:'Distance', width:150, sort: true, fixed: false, hide: false, title: '距离（km）' }
                , {field:'Frequence', width:150, sort: true, fixed: false, hide: false, title: '次数（千次）' }
