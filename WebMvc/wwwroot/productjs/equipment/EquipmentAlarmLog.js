layui.config({
    ...
    var TableName = 'EquipmentAlarmLog';
    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , { field: 'EquipmentAlarmTextCode', width: 150, sort: true, fixed: false, hide: false, title: '报警代号', templet: function (d) { return GetLabel('EquipmentAlarmTextCode', 'Code', 'Text', d.EquipmentAlarmTextCode) } }
                , {field:'HoldTime', width:150, sort: true, fixed: false, hide: false, title: '持续时间(min)' }
    ...
    var selector = {
        ...
        }, 'EquipmentAlarmTextCode': {
            SelType: "FromUrl",
            SelFrom: "/equipment/EquipmentAlarmText/Load",
            SelModel: "EquipmentAlarmTextCode",
            SelLabel: "Text",
            SelValue: "Code",
            Dom: [$("[name='EquipmentAlarmTextCode']"), $("[name='qEquipmentAlarmTextCode']")]
        },
    };
