    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'Id', width:80, sort: true, fixed: false, hide: false, title: '唯一编号' }
                ...
                , {field:'InventoryNum', width:150, sort: true, fixed: false, hide: false, title: '库存数量' }
                , {field:'AlertNum', width:150, sort: true, fixed: false, hide: false, title: '预警数量' }
