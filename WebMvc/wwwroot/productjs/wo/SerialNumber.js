    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'SerialNumberMember', width:200, sort: true, fixed: false, hide: false, title: '序列号' }
                , {field:'SerialRule', width:150, sort: true, fixed: false, hide: false, title: '条码规则' }
