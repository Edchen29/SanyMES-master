    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'Code', width:150, sort: true, fixed: false, hide: false, title: '不良代号' }
                , {field:'Name', width:150, sort: true, fixed: false, hide: false, title: '不良名称' }
                , { field: 'StationId', width: 150, sort: true, fixed: false, hide: false, templet: function (d) { return GetLabel('StationId', 'Id', 'Name', d.StationId) }, title: '工位' }
                , { field: 'Type', width: 150, sort: true, fixed: false, hide: false, templet: function (d) { return GetLabel('Type', 'DictValue', 'DictLabel', d.Type) }, title: '不良分类' }
