    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'Code', width:150, sort: true, fixed: false, hide: false, title: '维修代号' }
                , {field:'Name', width:150, sort: true, fixed: false, hide: false, title: '维修名称' }
                , { field: 'NGCode', width: 150, sort: true, fixed: false, hide: false, templet: function (d) { return GetLabel('NGCode', 'Code', 'Name', d.NGCode) }, title: '不良代号' }
