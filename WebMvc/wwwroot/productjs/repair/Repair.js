    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'ItemCode', width:150, sort: true, fixed: false, hide: false, title: '产品' }
                , {field:'SerialNumber', width:150, sort: true, fixed: false, hide: false, title: '序列号' }
                , {field:'MaterialCode', width:150, sort: true, fixed: false, hide: false, title: '不良部件' }
                , {field:'NGcode', width:150, sort: true, fixed: false, hide: false, title: '不良代号' }
                , {field:'RepairCode', width:150, sort: true, fixed: false, hide: false, title: '维修代号' }
                , {field:'Status', width:150, sort: true, fixed: false, hide: false, title: '修复状态' }
                , {field:'NGMarkUser', width:150, sort: true, fixed: false, hide: false, title: '打不良人员' }
                , {field:'RepairUser', width:150, sort: true, fixed: false, hide: false, title: '维修人员' }
                , {field:'Suggestion', width:150, sort: true, fixed: false, hide: false, title: '维修意见' }
