    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'MaterialCode', width:150, sort: true, fixed: false, hide: false, title: '物料编号' }
                , {field:'MaterialUnitCode1', width:150, sort: true, fixed: false, hide: false, title: '物料单位' }
                , {field:'MaterialUnitCode2', width:150, sort: true, fixed: false, hide: false, title: '物料换算单位' }
                , {field:'Multiple', width:150, sort: true, fixed: false, hide: false, title: '换算倍率' }
