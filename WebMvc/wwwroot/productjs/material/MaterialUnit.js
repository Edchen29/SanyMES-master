    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'Code', width:150, sort: true, fixed: false, hide: false, title: '单位代码' }
                , {field:'Name', width:150, sort: true, fixed: false, hide: false, title: '单位名称' }
