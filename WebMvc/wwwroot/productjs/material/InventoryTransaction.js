    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'FactoryId', width:150, sort: true, fixed: false, hide: false, title: 'FactoryId' }
                , {field:'FactoryCode', width:150, sort: true, fixed: false, hide: false, title: 'FactoryCode' }
                , {field:'LineId', width:150, sort: true, fixed: false, hide: false, title: 'LineId' }
                , {field:'LineCode', width:150, sort: true, fixed: false, hide: false, title: 'LineCode' }
                ...
                , {field:'SourceLine', width:150, sort: true, fixed: false, hide: false, title: '上游系统行号' }
                , {field:'Type', width:150, sort: true, fixed: false, hide: false, title: '交易类型' }
                ...
                , {field:'DrawingCode', width:150, sort: true, fixed: false, hide: false, title: '项目号' }
