layui.config({
    ...
    var TableName = 'MaterialDistributeTaskDetail';
    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , { field: 'MaterialDistributeTaskHeaderId', width: 150, sort: true, fixed: false, hide: false, title: '头表标识' }
                ...
                , {field:'UserCode', width:150, sort: true, fixed: false, hide: false, title: '配盘操作员' }
