    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'ProductHeaderId', width:150, sort: true, fixed: false, hide: false, title: '产品标识' }
                ...
                , {field:'StepCode', width:150, sort: true, fixed: false, hide: false, title: '工序' }
                , {field:'ProgramCode', width:150, sort: true, fixed: false, hide: false, title: '工序程序' }
