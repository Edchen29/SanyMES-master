    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , {field:'FactoryCode', width:120, sort: true, fixed: false, hide: false, title: '工厂代号' }
                , {field:'FactoryName', width:200, sort: true, fixed: false, hide: false, title: '工厂名称' }
                , {field:'Address', width:250, sort: true, fixed: false, hide: false, title: '地址' }
                , {field:'Telephone', width:120, sort: true, fixed: false, hide: false, title: '电话' }
                , {field:'CompanyGroup', width:150, sort: true, fixed: false, hide: false, title: '集团' }
