    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , { field: 'LineCode', width: 120, sort: true, fixed: false, hide: false, title: '线体代号' }
                , { field: 'Code', width: 120, sort: true, fixed: false, hide: false, title: '工位代号' }
                , { field: 'Name', width: 150, sort: true, fixed: false, hide: false, title: '工位名称' }
                , { field: 'Sequence', width: 80, sort: true, fixed: false, hide: false, title: '顺序' }
                , { field: 'Attribute', width: 150, sort: true, fixed: false, hide: false, title: '工位属性', templet: function (d) { return GetLabel('Attribute', 'DictValue', 'DictLabel', d.Attribute) } }
                , { field: 'Enable', width: 100, sort: true, fixed: false, hide: false, title: '是否有效', templet: function (d) { return GetLabel('Enable', 'DictValue', 'DictLabel', d.Enable) } }
