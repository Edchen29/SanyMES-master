    ...
    var mainList = {
        Render: function () {
            var cols_arr = [[
                ...
                , { field: 'TrussTakeStationId', width: 150, sort: true, fixed: false, hide: false, title: '绗架取货站台编号' }
                , { field: 'TrussReleaseStationId', width: 150, sort: true, fixed: false, hide: false, title: '绗架放货站台编号' }
