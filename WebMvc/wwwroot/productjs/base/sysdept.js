layui.config({
    ...
    layui.droptree("/base/UserSession/GetOrgs", "#ParentName", "#ParentId", false);
    ...
    var mainList = function (options) {
        ...
        table.reload('mainList', {
            url: '/base/UserSession/GetSubOrgs'
            , method: 'POST'
            , where: config,
            page: {
                curr: 1 //重新从第 1 页开始
    ...
    var editDlg = function () {
        ...
        var show = function (data) {
            ...
            var url = "/base/SysDept/Add";
            if (update) {
                url = "/base/SysDept/Update"; //暂时和添加一个地址
            }
            //提交数据
